...
// exists.  Returns an error if the migration cannot be applied.
...
// Save inserts a new Feedback row into the database.
...
// List returns feedbacks ordered by creation time descending with limit/offset.
